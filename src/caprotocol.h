...
enum {
        ...
        CA_PROTOCOL_PULL_CHUNKS       = 0x10,  /* I'd like to pull chunks from you  */
        CA_PROTOCOL_PULL_INDEX        = 0x20,  /* I'd like to pull an index from you */
        CA_PROTOCOL_PUSH_CHUNKS       = 0x40,  /* I'd like to push chunks to you */
        CA_PROTOCOL_PUSH_INDEX        = 0x80,  /* I'd like to push an index to you */
        CA_PROTOCOL_PUSH_INDEX_CHUNKS = 0x100, /* I'd like you to pull chunks from me, that are declared in the index I just pulled */

        CA_PROTOCOL_FEATURE_FLAGS_MAX = 0x1ff,
};

typedef struct CaProtocolIndex {
        CaProtocolHeader header;
        uint8_t data[];
} CaProtocolIndex;

typedef struct CaProtocolIndexEOF {
        CaProtocolHeader header;
} CaProtocolIndexEOF;
