...
int ca_remote_request(CaRemote *rr, const CaObjectID *object_id, bool priority, const void **ret, size_t *ret_size);
int ca_remote_request_async(CaRemote *rr, const CaObjectID *object_id, bool priority);
